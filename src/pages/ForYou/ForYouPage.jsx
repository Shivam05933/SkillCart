              ...
              {error && (
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-3 w-full py-2 bg-rose-500 text-white rounded-xl text-xs font-bold hover:bg-rose-600 disabled:opacity-50 flex items-center justify-center gap-2"
                  >
